...
If your coming from the repository, just import the whole repository into replit.com and press the 'Run' button to start up the web app. Please open the application in a new window for the best experience.
